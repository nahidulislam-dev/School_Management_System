...
/// <summary>Validation rules for <see cref="UpdateExamScheduleDto"/>.</summary>
public class UpdateExamScheduleDtoValidator : AbstractValidator<UpdateExamScheduleDto>
{
    public UpdateExamScheduleDtoValidator()
    {
        RuleFor(x => x.Id)
            .GreaterThan(0).WithMessage("A valid exam schedule id is required.");
